const en = {
  ...
  toolbar: {
    ...
    newHint: 'New Ctrl+N',
    newCreated: 'New workflow created',
    confirmNew: 'Canvas has content, start new?',
    promptWorkflowName: 'Workflow name:',
  ...
  resource: {
    ...
    modelNode: 'AI Model',
    modelNodeDesc: 'Call LLM to generate content',
    inputNode: 'Input',
    inputNodeDesc: 'Provide initial data for workflow',
    codeNode: 'Code',
    codeNodeDesc: 'Execute custom JavaScript',
    apiNode: 'API Call',
    apiNodeDesc: 'Request external HTTP endpoint',
    conditionNode: 'Condition',
    conditionNodeDesc: 'Branch based on expression',
  ...
  settings: {
    ...
    confirmNoKey: 'No API Key provided. The model may not connect. Save anyway?',
    outputDir: 'Output Directory',
    outputDirPlaceholder: 'Default: ~/localcanvas-output/',
    outputDirHint: 'Default output path for FileOutput nodes',
  },
  toast: {
    skillAdded: 'Added: ',
  },
  saveModal: { title: 'Save Workflow', placeholder: 'Enter workflow name...', save: 'Save', cancel: 'Cancel' },
  loadModal: { title: 'Load Workflow', loading: 'Loading...', empty: 'No saved workflows', loadFailed: 'Failed to load' },
};
export default en;
